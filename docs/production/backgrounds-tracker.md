...
| `bg city square day` | `bg_city_square_day_market.png` | D08_M-S03/S04, Мираэль одна в городе, встреча издалека |
| `bg alex room night` | `bg_alex_room_night.jpeg` | D08_M-S05/S06, вечер и ночь дома |

Ни одного нового фона не потребовалось. Магазин одежды (сцена 3) показан тем же фоном площади
(`bg city square day`) без отдельного интерьера — фокус сцены на диалоге и внутреннем опыте
Мираэль, а не на визуальной детализации торгового зала.
