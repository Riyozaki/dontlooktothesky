...
## Подключено и используется (D08_M)

| Alias в `definitions.rpy` | Файл | Где используется |
|---|---|---|
| `bg alex room dawn` | `bg_alex_room_evening_or_dawn.jpeg` | D08_M-S01/S02, утро дома |
| `bg street day` | `bg_street_no_rain.jpeg` | D08_M-S03, прогулка Мираэль: голуби, слойка, скрипач, курьер |
| `bg city square day` | `bg_city_square_day_market.png` | D08_M-S04/S05, магазин и встреча издалека |
| `bg depot morning` | `bg_delivery_depot_morning_clean.png` | D08_M-S06, разгрузка с Костей после обеда |
| `bg private sector day` | `bg_private_sector_day.png` | D08_M-S06, доставка глушителя |
| `bg alex room night` | `bg_alex_room_night.jpeg` | D08_M-S07/S08, трофей и признание |

27.07.2026: ревизия D08_M расширила главу до 8 сцен (была 6). Ни одного нового фона не
потребовалось. Магазин одежды (S04) показан тем же фоном площади (`bg city square day`) без
отдельного интерьера — фокус сцены на диалоге и внутреннем опыте Мираэль, а не на визуальной
детализации торгового зала. Ларёк со слойками и лавка фигурки переданы текстом (S03/S07),
отдельные фоны не планируются.
