...
Старая реализация маршрутов Валерии и нейтрального расследования удалена. Новый маршрут Валерии V01–V08 и три исхода E03–E05 написаны, подключены и технически проверены. Для нового нейтрального маршрута утверждено ядро земного детектива; подробная причинная карта ещё обсуждается.
