...
Нейтральный маршрут полностью перепроектируется: отклонённая N01–N05 удалена из активной сборки. Новая версия сохраняет частное расследование Александра и Лены, но исключает полицию, страховую, операторов и другие земные учреждения из сверхъестественного конфликта.
